clear all;clc;
numClasses = 50;
cq_inputSize = 2688; % Size of input vector cq 2688*18305
lss_inputSize = 2000;
phog_inputSize = 252;
sift_inputSize = 2000;
rgsift_inputSize = 2000;
surf_inputSize = 2000;

%% hidden layer size

cq_hiddenSizeL1 = 200;    % Layer 1 Hidden Size
cq_hiddenSizeL2 = 20;    % Layer 2 Hidden Size

lss_hiddenSizeL1 = 200;    % Layer 1 Hidden Size
lss_hiddenSizeL2 = 20;    % Layer 2 Hidden Size

sift_hiddenSizeL1 = 200;    % Layer 1 Hidden Size
sift_hiddenSizeL2 = 20;    % Layer 2 Hidden Size

surf_hiddenSizeL1 = 200;    % Layer 1 Hidden Size
surf_hiddenSizeL2 = 20;    % Layer 2 Hidden Size

rgsift_hiddenSizeL1 = 200;    % Layer 1 Hidden Size
rgsift_hiddenSizeL2 = 20;    % Layer 2 Hidden Size

phog_hiddenSizeL1 = 50;    % Layer 1 Hidden Size
...
load 'D:\ML Matlab\Data\AWA\cq_trx.mat'          % ����ѵ�����?
load 'D:\ML Matlab\Data\AWA\cq_try.mat'
load 'D:\ML Matlab\Data\AWA\lss_trx.mat'
load 'D:\ML Matlab\Data\AWA\surf_trx.mat'
load 'D:\ML Matlab\Data\AWA\sift_trx.mat'
load 'D:\ML Matlab\Data\AWA\phog_trx.mat'
load 'D:\ML Matlab\Data\AWA\rgsift_trx.mat'
...
clear hwave;
clear hwsigma;
clear cq_trx;clear lss_trx;clear phog_trx;clear sift_trx;clear surf_trx;clear rgsift_trx;
MaxIter = 400;
%%======================================================================
...
load 'D:\ML Matlab\Data\AWA\cq_tx.mat'           % ���ز������?
load 'D:\ML Matlab\Data\AWA\cq_ty.mat'
load 'D:\ML Matlab\Data\AWA\lss_tx.mat'
load 'D:\ML Matlab\Data\AWA\surf_tx.mat'
load 'D:\ML Matlab\Data\AWA\sift_tx.mat'
load 'D:\ML Matlab\Data\AWA\phog_tx.mat'
load 'D:\ML Matlab\Data\AWA\rgsift_tx.mat'
...
clear hwave;
clear hwsigma;
clear cq_tx;clear lss_tx;clear phog_tx;clear sift_tx;clear surf_tx;clear rgsift_tx;
