...
cq_hiddenSizeL1 = 150;    % Layer 1 Hidden Size
cq_hiddenSizeL2 = 60;    % Layer 2 Hidden Size

lss_hiddenSizeL1 = 40;    % Layer 1 Hidden Size
lss_hiddenSizeL2 = 40;    % Layer 2 Hidden Size

phog_hiddenSizeL1 = 110;    % Layer 1 Hidden Size
phog_hiddenSizeL2 = 50;    % Layer 2 Hidden Size

sift_hiddenSizeL1 = 110;    % Layer 1 Hidden Size
sift_hiddenSizeL2 = 50;    % Layer 2 Hidden Size

surf_hiddenSizeL1 = 50;    % Layer 1 Hidden Size
surf_hiddenSizeL2 = 40;    % Layer 2 Hidden Size

sparsityParam = 0.1;   % desired average activation of the hidden units.
                       % (This was denoted by the Greek alp23whabet rho, which looks like a lower-case "p",
		               %  in the lecture notes). 
lambda = 5e-3;         % weight decay parameter       
...
cq_trx = new_train_CM55';
trainLabels = NWO_Train_Labels';
lss_trx = new_train_CH';
phog_trx = new_train_CORR';
sift_trx = new_train_WT';
surf_trx = new_train_EDH';
...
cq_tx = new_test_CM55';
lss_tx = new_test_CH';
phog_tx = new_test_CORR';
sift_tx = new_test_WT';
surf_tx = new_test_EDH';
