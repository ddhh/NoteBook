function [pred] = NUS_multistackedAEPredict(theta, inputSize, hiddenSize, numClasses, netconfig, data, softmaxOTheta)
...
%{
cq_stack = params2stack(theta{1}, netconfig{1});
lss_stack = params2stack(theta{2}, netconfig{2});
phog_stack = params2stack(theta{3}, netconfig{3});
sift_stack = params2stack(theta{4}, netconfig{4});
surf_stack = params2stack(theta{5}, netconfig{5});
%}
Size = sum(hiddenSize);
