...
sift_hiddenSizeL2 = 30;    % Layer 2 Hidden Size

surf_hiddenSizeL1 = 20;    % Layer 1 Hidden Size
surf_hiddenSizeL2 = 20;    % Layer 2 Hidden Size

rgsift_hiddenSizeL1 = 5;    % Layer 1 Hidden Size
rgsift_hiddenSizeL2 = 4;    % Layer 2 Hidden Size
...
testLabels = cq_ty;
lss_testData = lss_tx;
surf_testData = surf_tx;
sift_testData = sift_tx;
phog_testData = phog_tx;
rgsift_testData = rgsift_tx;
%}
