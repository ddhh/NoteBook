...
cq_hiddenSizeL1 = 50;    % Layer 1 Hidden Size
cq_hiddenSizeL2 = 30;    % Layer 2 Hidden Size

lss_hiddenSizeL1 = 120;    % Layer 1 Hidden Size
lss_hiddenSizeL2 = 40;    % Layer 2 Hidden Size

phog_hiddenSizeL1 = 60;    % Layer 1 Hidden Size
phog_hiddenSizeL2 = 30;    % Layer 2 Hidden Size

sift_hiddenSizeL1 = 150;    % Layer 1 Hidden Size
sift_hiddenSizeL2 = 50;    % Layer 2 Hidden Size

surf_hiddenSizeL1 = 50;    % Layer 1 Hidden Size
surf_hiddenSizeL2 = 40;    % Layer 2 Hidden Size

rgsift_hiddenSizeL1 = 10;    % Layer 1 Hidden Size
...
%setaccuracy = zeros(51,1);
%ai = 1;
%for spar = 0:0.01:0.5
sparsityParam = 0.2;% 0.1;   % desired average activation of the hidden units.  0.1
...
selectid = randperm(200,40);  % Ëæ»úÑ¡Ôñ 20% ×÷ÎªÑµÁ·Êý¾Ý¼¯
