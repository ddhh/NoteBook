...
inputSize = 2688; % Size of input vector cq 2688*18305
numClasses = 50;
...
load 'animal/cq_tx.mat'           % 加载测试数据
load 'animal/cq_ty.mat'

load 'animal/cq_trx.mat'          % 加载训练数据
load 'animal/cq_try.mat'
...
fprintf('Train the first sparse autoencoder\n');
